...
export const signup = async (req, res, next) => {
  ...
  if (!email || !name) {
    return res.status(400).json({ succes: false, message: 'Name and email are required' })
  }
  ...
  try {
    ...
    return res.status(500).json({ succes: false, message: 'An internal server error occured' })
  }
};
